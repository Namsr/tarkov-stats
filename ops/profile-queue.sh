...
# Freshness runs before optional parser backfill.
...
run_mode arena dc -e ARENA_PROFILE_SYNC_RPS=1 -e ARENA_PROFILE_SYNC_MAX_RUN_MS=480000 web $node scripts/sync-arena-profiles.mjs
