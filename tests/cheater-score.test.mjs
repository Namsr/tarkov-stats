...
import { ADMIN_RISK_SCORE_VERSION, ADMIN_RISK_SCORE_VERSIONS, SEASONAL_RISK_SCORE_VERSION, adminRiskScoreVersion, scoreCheater } from "../lib/cheater-score.ts";
...
test("stored risk version invalidates the previous seasonal population", () => {
  ...
  assert.deepEqual(ADMIN_RISK_SCORE_VERSIONS, { regular: 1, pve: 1, seasonal: 2 });
  ...
  assert.equal(adminRiskScoreVersion("seasonal", ""), 1);
});
