...
type HealthPhase = { phase: "profile" | "baseline" | "metadata" | "mastery" | "cohort" | "store_read" | "store_write" | "averages" | "bucket_aggregate" | "range_bounds"; samples: number; p50Ms: number | null; p95Ms: number | null; p99Ms: number | null };
