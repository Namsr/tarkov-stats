...
type AveragePublication = { scope: string; generation: number | null; generatedAt: number | null; dirtyAt: number | null; lastStartedAt: number | null; lastCompletedAt: number | null; lastDurationMs: number | null; lastError: string | null; variants: number; status: "warming" | "dirty" | "processing" | "ready" | "error" };
